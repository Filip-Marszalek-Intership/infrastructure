...
az vm create --name $VMNAME --ssh-key-value $RSA --storage-sku $DISKTIER --resource-group build-agents-01 --image $VMIMAGE --vnet-name $VNETNAME --subnet $SUBNETNAME --size $SIZE $RESIP $PUBNAME
