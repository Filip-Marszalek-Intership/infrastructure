...
az vm create --name $VMNAME --ssh-key-values session07/05/public.rsa --storage-sku $DISKTIER --resource-group build-agents-01 --image $VMIMAGE --vnet-name $VNETNAME --subnet $SUBNETNAME --size $SIZE $RESIP $PUBNAME
