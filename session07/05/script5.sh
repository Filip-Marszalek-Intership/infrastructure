...
az vm create --name $VMNAME --ssh-key-values public.rsa --storage-sku $DISKTIER --resource-group build-agents-01 --image $VMIMAGE --vnet-name $VNETNAME --subnet $SUBNETNAME --size $SIZE $RESIP $PUBNAME
